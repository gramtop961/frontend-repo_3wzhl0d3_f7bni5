...
export default function HeroSpline() {
  return (
    <section className="relative h-screen w-screen overflow-hidden bg-black text-white">
      ...
      {/* Soft gradient that won't block interaction or wash out colors */}
      ...
      <div className="pointer-events-none absolute bottom-6 left-1/2 z-10 -translate-x-1/2">
        <motion.div
          ...
          className="flex flex-col items-center gap-2 text-xs text-white/75"
        >
          <span>Scroll to begin</span>
          <span className="inline-block h-6 w-3 rounded-full border border-white/40">
            <motion.span
              className="mx-auto mt-1 block h-2 w-[2px] rounded bg-white/80"
